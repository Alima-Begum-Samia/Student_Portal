    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_duration', models.CharField(blank=True, default='', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrolledBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('enrolledCourse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.offeredcourses')),
            ],
        ),
    ]
